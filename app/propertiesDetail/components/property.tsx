...
const property = ( ) => {
  ...
  return (
    ...
    <div className={`flex flex-shrink-0 w-fit  gap-2 bg-white border shadow p-1 rounded-lg text-lightGray flex-col`}>
        ...
        <div className={`flex flex-col basis-2/3 py-2 px-1`}>
            <div className={` flex justify-between gap-6`}>
                <h1 className="text-lg mt-2 text-black my-auto font-semibold">Glam Apartment No.3</h1>
