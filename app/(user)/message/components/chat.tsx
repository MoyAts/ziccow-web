...
const chat = ({ isCurrentUser }: Props) => {
  return (
    <div
      className={`w-full flex gap-2 ${isCurrentUser && "flex-row-reverse"} bg-red-00`}
    >
      {isCurrentUser ? (
      ...
      <div
        className={`w-fit  max-w-[50%] max-mobile:max-w-[75%] ${isCurrentUser ? "bg-white  rounded-b-xl rounded-l-xl" : "bg-[#EEF6FE] rounded-b-xl rounded-r-xl"}  px-4 py-3 flex flex-col gap-2 `}
      >
