    ...
    <div className="flex flex-col px-20 max-tablet:px-10 max-mobile:px-5 max-w-[1700px] max-h-[1200px] mx-auto">
      <div className="flex flex-col mt-10">
        ...
        <p className="text-lightGray">
          Messages replied to within 1 hour, 7 days a week.
        </p>
      </div>
      ...
      {nothingFound ? (
        ...
        <>
          <div
            id="message-top"
            className="flex h-[100vh] max-tablet:hidden max-h-[800px] mt-8 w-full mb-16"
          >
          ...
          <div
            id="message-top"
            className="flex h-[100vh] tablet:hidden max-h-[800px] mt-8 w-full mb-16"
          >
            {messages.length == 0 && (
              <Users tablet={true} setMessage={setMessages} />
            )}
            {messages.length > 0 && (
              <Message
                tablet={true}
