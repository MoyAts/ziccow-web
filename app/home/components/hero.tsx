  ...
  return (
    <div className="w-full bg-[#6b6d77] tablet:h-[112vh] max-tablet:h-fit max-tablet:pb-32 max-mobile:pb-8     mx-auto  tablet:max-h-[800px] relative flex flex-col ">
      ...
      <div className="flex max-tablet:pt-32  px-10 max-small:px-5 flex-col items-center justify-center  tablet:max-h-[850px] max-tablet:h-full z-[500]  h-[112vh] w-full max-w-[1700px] mx-auto  ">
        <div className=" text-[50px] max-mobile:text-[35px]  flex flex-col gap-0  text-white text-center">
        ...
        <p
          ...
          style={{ color: "#E8E8E9" }}
        >
          Want to find a suitable home? We are ready to help you find one that
        ...
        <div className="w-8/12 max-tablet:w-10/12 max-small:w-full mt-10 mx-auto  bg-white py-2 flex justify-between rounded-2xl px-2">
          ...
          <Link
            href={
              !search.trim() ? "/properties" : "/properties/?search=" + search
            }
            className="mobile:hidden w-fit px-6 flex justify-center "
          >
          ...
          <Link
            ...
            className="flex gap-2 w-fit max-mobile:hidden  bg-mainBlue text-white px-6 text-sm justify-center hover:bg-blue-500 py-3 rounded-lg"
          >
            <Image src={searchImg} className="" alt="" />
            <span className="my-auto w-full max-mobile:hidden">
              See&nbsp;Suggestions
            </span>
          </Link>
        </div>

        <p className="text-[#E8E8E9] mt-32 text-lg font-light">
          Or browse through the highlights
        </p>
