  ...
  return (
    <div className="h-fit  pt-10 max-tablet:pt-32 flex mb-[8em] ">
      <div className=" w-full max-w-[1700px] mx-auto flex flex-col items-center px-20 max-small:px-5 max-tablet:px-10">
        <p className="text-blue-400 text-center text-lg font-light">
          Real estates across the town
        </p>
        <div className="text-[45px] max-tablet:text-[35px]  font-semibold text-center">
          View our featured top{" "}
          <span className="text-blue-600">real estates.</span>{" "}
        </div>
        <Link
          href={"/recommendation"}
          className="flex gap-2 mt-8 px-4 py-2 hover:bg-blue-600 rounded-lg bg-mainBlue max-mobile:w-full max-mobile:justify-center w-fit  text-white mx-auto text-lg"
        >
            ...
            <div className="flex justify-between gap-10 max-mobile:flex-col">
              <div className="relative w-full ">
                <Image
                  src={img1}
                  alt=""
                  className="w-full max-mobile:max-h-[300px] object-cover rounded-3xl"
                />
                <div className="absolute bottom-5 left-5 text-white">
                  <div className="text-[35px]  max-mobile:text-[40px]">234</div>
                  <p className="text-xl max-tablet:lg font-light ">
                    Flintstone Homes
                  </p>
                </div>
              </div>
