...
const DowloadApp = () => {
  return (
    <div className='flex flex-col  h-full pb-20 max-w-[1700px] mx-auto items-center pt-5' >
        <div className="flex h-5/6 w-full relative">
            <Image src={mockupimg} className="object-contain w-[65%] mx-auto h-full" alt="" />
            <div className="absolute bottom-0 left-0 right-0 h-1/2 bg-gradient-to-b from-transparent to-lightBg"></div>
        </div>
        <h1 className="flex gap-2 text-[45px] mt-12 font-normal">
