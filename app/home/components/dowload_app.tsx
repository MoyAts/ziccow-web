...
const DowloadApp = () => {
  return (
    <div className='flex flex-col  h-full pb-20 max-tablet:pb-5  max-tablet:px-10 max-w-[1700px] mx-auto items-center pt-5' >
        ...
        <h1 className="text-[45px] max-sm:text-[30px] max-sm:text-center max-tablet:text-[35px] mt-12 font-normal">
        ...
        <div className="flex gap-12 max-sm:gap-0 max-sm:justify-around mt-12">
            <Image src={playstoreIcon} alt="" className="cursor-pointer max-sm:w-1/2 hover:scale-110 duration-200" />
            <Image src={appstoreIcon} alt="" className="cursor-pointer max-sm:w-1/2 hover:scale-110 duration-200"  />
        </div>
