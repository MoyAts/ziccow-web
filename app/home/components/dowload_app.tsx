  ...
  return (
    <div className="flex flex-col  h-full  pb-20 max-tablet:pb-5 max-mobile:px-5  max-tablet:px-10 max-w-[1700px]  mobile:mx-auto items-center pt-5">
      <div className="flex tablet:h-5/6 w-full relative bg--300">
        <Image
          src={mockupimg}
          className="object-contain w-[65%] max-tablet:w-full max-mobile:w-[100vh]  mobile:mx-auto h-full"
          alt=""
        />
      ...
      <p className=" text-center my-3">
        Please feel free to download our app on the app store or google play
        store to evaluate our product.
      </p>
