...
const difference = () => {
  return (
    <div className="w-full">
        <div id='services' className='h-[100vh] max-w-[1700px] mx-auto  max-h-[700px]   flex max-tablet:flex-col max-tablet:px-10 px-20 max-mobile:px-0  ' >
            <div className='flex flex-col my-auto gap-3 max-tablet:gap-6 max-tablet:px-8 max-mobile:px-5  max-tablet:justify-center max-tablet:items-center w-6/12 max-tablet:w-full max-tablet:mt-20'>
                ...
                <div className='text-[54px] max-mobile:text-[35px] max-tablet:text-[40px] max-tablet:text-center w-full' style={{lineHeight:1}}>
                    <span className=''>
