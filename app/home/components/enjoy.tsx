...
const index = () => {
  return (
    <div className="w-full bg-mainDark h-[45vh] max-h-[300px] flex">
      <div className='w-full max-w-[1700px]  m-auto  flex gap-12 py-20 px-20 text-white' >
        <div className='basis-3/12 text-[25px] '  >
              Enjoy quality life with our housing services.
        </div>
        <p className='basis-9/12 text- my-auto text-gray-400'>
