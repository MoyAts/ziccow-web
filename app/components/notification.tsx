...
const notification = () => {
  return (
    <div className="bg-white relat z-[1000] absolute top-12 shadow-lg right-1/4 text-sm w-[240px]  py-4 rounded-lg">
      <div className="w-5 h-5 bg-white absolute -top-2 rotate-45 left-[31%]"></div>
      <h1 className="font-semibold mb-3 px-2">Notification</h1>
