...
const teams = () => {
  return (
    <div className="w-full bg-lightBg">
        <div className='h-fit w-full max-w-[1700px] max-h-[800px] mx-auto pb-16 px-[5em] '>
            ...
            <p className="text-center text-gray-500 text-sm px-20 mt-5">
            ...
            <div className="grid grid-cols-3 justify-items-center mt-8 gap-10 px-10">
