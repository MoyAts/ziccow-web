            ...
            <div className="grid grid-cols-3  max-small:grid-cols-1 max-tablet:grid-cols-2 justify-items-center mt-8 gap-10 px-10">
                    ...
                    >
                        <div className="mx-auto rounded-full">
                            <Image  src={img1} className="rounded-full w-32 h-32 object-cover" alt="" />
                        </div>
                    ...
                    <Link href={{
                        ...
                        <div className="mx-auto rounded-full">
                            <Image src={img2} className="rounded-full w-32 h-32 object-cover" alt="" />
                        </div>
                    ...
                    <Link href={{
                        ...
                        className="flex flex-col  w-fit gap-1 max-tablet:w-full">
                        <div className="mx-auto rounded-full">
                            <Image src={img3} className="rounded-full w-32 h-32 object-cover" alt="" />
                        </div>
                    ...
                    <Link href={{
                        ...
                        <div className="mx-auto rounded-full">
                            <Image src={img4} className="rounded-full w-32 h-32 object-cover" alt="" />
                        </div>
                    ...
                    <Link href={{
                        ...
                        className="flex flex-col  w-fit gap-1 max-tablet:w-full">
                        <div className="mx-auto rounded-full">
                            <Image src={img5} className="rounded-full w-32 h-32 object-cover" alt="" />
                        </div>
                    ...
                    <Link href={{
                        ...
                        className="flex flex-col  w-fit gap-1 max-tablet:w-full">
                        <div className="mx-auto rounded-full">
                            <Image src={img6} className="rounded-full w-32 h-32 object-cover" alt="" />
                        </div>
