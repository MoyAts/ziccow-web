...
const SelectOption = ({ list, img, checkbox, name, filter, reset }: Props) => {
  ...
  return (
    <div className="relative flex flex-col gap-2  py-1 group rounded-lg  ">
      <div
        className={`${selected ? "bg-blue-200 shadow" : "bg-white"}  flex justify-between  py-1 rounded px-2`}
      >
