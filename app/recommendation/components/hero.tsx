  ...
  return (
    <div className='w-full  relative z-20 flex flex-col'>
        ...
        <div className="w-full max-w-[1700px]  items-center  h-[100vh] max-h-[750px] relative flex mx-auto">
            ...
            <div  className=' ps-20 max-tablet:ps-10 z-50 flex flex-col  text-white text-3xl'>
                <h1 className='text-[45px] flex flex-col gap-2 pe-10'>
                    <span >
                ...
                <div className='flex overflow-auto w-fit pe-20  mt-10 font-light text-sm justify-between gap-12'>
                
                    <div className='flex shrink-0  max-w-[300px] flex-col group px-2 py-4 duration-300 rounded-lg hover:bg-gray-400 hover:bg-opacity-50'>
                    ...
                    <div className='flex shrink-0  max-w-[300px] flex-col  px-2 py-4 group duration-300 rounded-lg hover:bg-gray-400 hover:bg-opacity-50'>
                        <div className='h-[4px] w-full bg-slate-500 group-hover:bg-mainBlue'></div>
                        <h1 className='font-semibold my-2'>Extraordinary</h1>
                        <p>
                            Provide a robust synopsis for high level overviews and iterative approaches.
