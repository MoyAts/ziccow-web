...
const Table = () => {
  ...
  return (
      <table className="min-w-full bg-white mt-10 rounded-t-lg">
        <thead>
          <tr >
        ...
        <tbody className='bg-lightBg'>
          {data.map((item) => (
            <tr key={item.id} className='h-14'>
              ...
              <td className="py-2 px-4 border-b border-gray-300 text-left font-semibold text-mainBlue">{item.name}</td>
              <td className="py-2 px-4 border-b border-gray-300 text-left">{item.date}</td>
              <td className="py-2 px-4 border-b border-gray-300 text-left">{item.type}</td>
              <td className="py-2 px-4 border-b border-gray-300 text-left">{item.propertyType}</td>
              <td className={`py-2 px-4 border-b border-gray-300 text-left ${item.status == "Published" && ""}`}>{item.status}</td>
