...
const PhoneLoginPage = () => {
  ...
  if (responses.data) {
    ...
    console.log({
      ...
      userId: data.socialLogin.user.user_id,
    });
    dispatch(
      loginUser({
        token: data.socialLogin.token,
  ...
  return (
    ...
    >
      ...
      <div
        className="h-fit min-h-[100vh] w-3/5 max-lg:w-4/5  max-sm:w-full max-sm:px-5 flex z-10 mx-auto px-40 max-tablet:px-10 pb-20 pt-12"
      ...
      >
        <div className="mx-auto">
          ...
          <h3 className="capitalize text-xl my-5 font-semibold">
            Sign up With Phone
          </h3>
          ...
          >
            {error && (
              <div className="w-full rounded-xl border-2 mt-3 ps-3 py-2  border-red-400 bg-red-400 bg-opacity-40">
                {error}
              </div>
            )}
            {!setupPhone ? (
