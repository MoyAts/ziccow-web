        ...
        <div className='h-fit min-h-[100vh] w-3/5 max-lg:w-4/5 max-md:px-12 max-sm:w-full max-sm:px-5 flex z-10 mx-auto px-40 pb-20 pt-12' style={{background: "#F3EFF5"}}>
            ...
            <div className='mx-auto'>
                ...
                <form className='flex flex-col gap-7' onSubmit={e => e.preventDefault()}>
                    <CustomeInput name='' label={"name"} placeholder={"name"}/>
                    <CustomeInput name='' label={"phone number"} placeholder={"phone number"}/>
                    <CustomeInput name='' label={"email address"} placeholder={"email"}/>
                    <CustomeInput name='' pass={true} label={"create password"} placeholder={"password"} />
                    <CustomeInput name='' pass={true} label={"confirm password"} placeholder={"password"} />
