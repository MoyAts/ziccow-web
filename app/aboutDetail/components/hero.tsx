...
const hero = () => {
  return (
    <div className="h-fit max-w-[1700px]  px-20 mx-auto border-t border-gray-400">
        ...
        <div className="mt-6">
            <h1 className="text-[35px]">Our Honorary Partners.</h1>
            <p className="text-lightGray">We would also like to extend our gratitude to all our supporters and well-wishers who have played a crucial role in our journey.</p>
        </div>

        <div className="flex w-full mt-12 pb-12 gap-5">
            <div className="w-1/3  flex justify-center my-auto">
                <Image src={Photo} className="w-3/4 object-contain " alt="" />
            </div>
            <div className='flex w-2/3  flex-col gap-5 text-lightGray'>
